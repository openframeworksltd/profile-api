# profile-api
This API is used in building profile page
## ❯ Table of Contents
...
> This installs all dependencies and After that it migrates the database and seeds some test data into it. So after that your development environment is ready to use.

### Step 3: Serve your App

Go to the project dir and start your app with this yarn or npm script.
...
- Run `yarn or npm start serve` to start nodemon with ts-node, to serve the app.
- The server address will be displayed to you as `http://0.0.0.0:3000`

### Building the project and run it

- Run `yarn or npm start build` to generated all JavaScript files from the TypeScript sources 
- To start the builded app located in `dist` use `yarn or npm start`.
...
- To migrate your database run `yarn or npm start db.migrate`.
- To revert your latest migration run `yarn or npm start db.revert`.
- Drops the complete database schema `yarn or npm start db.drop`.

### Database Seeding

- Run `yarn or npm start db.seed` to seed your seeds into the database.
...
| Command                                              | Description |
| ---------------------------------------------------- | ----------- |
| `yarn or npm start "db.seed"`                               | Run all seeds |
| `yarn or npm start "db.seed --run CreateBruce,CreatePets"`  | Run specific seeds (file names without extension) |
| `yarn or npm start "db.seed -L"`                            | Log database queries to the terminal |
| `yarn or npm start "db.seed --factories <path>"`            | Add a different path to your factories (Default: `src/database/`) |
| `yarn or npm start "db.seed --seeds <path>"`                | Add a different path to your seeds (Default: `src/database/seeds/`) |
